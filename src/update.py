  ...
  for git_file in file_status_list:
    ...
    if git_file[1] != ".gitignore":
      ...
      if git_file[0] == 'A':
        ...
        print _("update_hook_error"), _("filestatus_not_supported"), efile
        sys.exit(1)

    else:

      ignored_path = cc_view_path + git_file[1]
      print _("NOTICE") + ": " + ignored_path + _("avoided_file")
...
def main():
  ...
  try:
    ...
    print _("update_hook_error"), e.value
    sys.exit(1)
  ...
  if refs[1] == "heads" and  refs[2] in config.get_sync_branches():
    ...
    try:
      ...
      print _("update_hook_unexpected_error"), sys.exc_info()
      sys.exit(1)
    ...
    if sync:
      ...
      try:
        ...
        process_push(committer, comments, file_status_list, old_revision,
                      new_revision)
        ...
        print _("update_hook_unexpected_error"), traceback.format_exc()
    ...
    if refs[1] == "heads":
      ...
      print _("branch_not_sync") + refs[2]
